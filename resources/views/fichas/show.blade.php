<x-app-layout>
    {{-- Fundo fixo com overlay (igual ao create) --}}
    <div class="fixed inset-0 -z-10">
        <img src="{{ asset('images/fundo_show.png') }}" alt="Background" class="w-full h-full object-cover opacity-40">
    ...
    <div id="capture-area" class="relative py-12 px-6 max-w-7xl mx-auto mb-20 min-h-screen">
        ...
        {{-- BARRA DE NAVEGAÇÃO SUPERIOR (escondida no PDF) --}}
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="space-y-6 animate-fadeInUp" style="animation-delay: 0.1s">
                {{-- Imagem principal com marca d'água da civilização --}}
            ...
            <div class="lg:col-span-2 space-y-6 animate-fadeInUp" style="animation-delay: 0.2s">
                ...
                <div class="ark-panel !p-8 relative overflow-hidden">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-start mb-8 relative gap-6">
                        <div>
                            ...
                            <p class="theme-text-primary tracking-[0.3em] font-bold uppercase mt-3 text-sm">{{ $ficha->class_sub }}</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {{-- Mutações (cor baseada no tema, mas com destaque próprio) --}}
                    <div class="ark-panel !p-6">
