<x-app-layout>
    <x-slot name="title">💖 PARABÉNS, VC CONSEGUIU AMOR!</x-slot>
    ...
    <style>
        ...
        .amor-bg {
            ...
            background: 
                ...
                url('{{ asset('images/fundo_amor.png') }}') center/cover no-repeat;
    ...
    <div class="amor-content">
        ...
        <div class="amor-header">
            <div class="logo">
                <x-application-logo class="w-full h-full" style="fill: #ff3b6f; filter: drop-shadow(0 0 10px #ff3b6f);" />
            </div>
        ...
        <div class="cards-grid">
            @foreach ($personagens as $index => $p)
                <div class="personagem-card" style="--aura-color: {{ $p['cor'] }};">
                    <div class="aura"></div>
                    <div class="imagem-wrapper">
                        <img src="{{ asset('images/'.$p['imagem']) }}" alt="{{ $p['nome'] }}" loading="lazy">
                    </div>
                    <div class="nome-personagem">{{ $p['nome'] }}</div>
                    <button class="btn-inspecionar" onclick="abrirModal({{ $index }})">
                        Inspecionar Ficha
                    </button>
                </div>
            @endforeach
    ...
    <script>
        ...
        const personagens = @json($personagens);
        ...
        function abrirModal(index) {
            ...
            const imgPath = '{{ asset('images/') }}' + '/' + p.imagem;
