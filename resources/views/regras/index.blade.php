{{-- resources/views/regras/index.blade.php (ou regras.blade.php) --}}
<x-app-layout>
    {{-- Meta tags para prévia social (WhatsApp, Facebook, etc.) --}}
    ...
    {{-- Fundo fixo com imagem e overlay (igual à home) --}}
    ...
    <div class="relative z-10 min-h-screen flex items-center justify-center py-12">
        <div class="max-w-5xl mx-auto px-6 w-full">
            ...
            {{-- Painel principal com efeito glossy e scanner --}}
            <div class="ark-panel-glossy p-8 md:p-12 text-center border border-cyan-500/30 shadow-[0_0_40px_rgba(0,242,255,0.2)] bg-black/40 backdrop-blur-sm rounded-2xl relative overflow-hidden">
                ...
                {{-- Card de versão com efeito de brilho --}}
                ...
                {{-- Botão de download com efeito glitch e ícone --}}
                <div class="mt-2">
