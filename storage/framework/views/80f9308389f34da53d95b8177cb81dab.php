...
<?php $component->withAttributes([]); ?>
    ...
    <div class="relative py-12 px-6 max-w-7xl mx-auto">
        ...
        <div class="flex flex-col items-center mb-12">
            <?php if (isset($component)) { $__componentOriginaldcd516c8a806a44695bb71f656d20154 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldcd516c8a806a44695bb71f656d20154 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ark-title','data' => ['title' => 'Suas Fichas']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ark-title'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Suas Fichas']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginaldcd516c8a806a44695bb71f656d20154)): ?>
<?php $attributes = $__attributesOriginaldcd516c8a806a44695bb71f656d20154; ?>
<?php unset($__attributesOriginaldcd516c8a806a44695bb71f656d20154); ?>
<?php endif; ?>
<?php if (isset($__componentOriginaldcd516c8a806a44695bb71f656d20154)): ?>
<?php $component = $__componentOriginaldcd516c8a806a44695bb71f656d20154; ?>
<?php unset($__componentOriginaldcd516c8a806a44695bb71f656d20154); ?>
<?php endif; ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
            <a href="<?php echo e(route('fichas.create')); ?>" 
            ...
            <?php $__currentLoopData = $characters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $char): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="ark-card group h-[400px] p-0 flex flex-col animate-fadeInUp relative overflow-hidden backdrop-blur-md bg-black/40 border <?php echo e($char->is_resgatada ? 'border-white' : 'border-cyan-500/20'); ?> hover:border-cyan-400/60 transition-all duration-500 shadow-lg hover:shadow-[0_0_30px_rgba(0,242,255,0.2)]" 
                     style="animation-delay: <?php echo e($loop->index * 0.1); ?>s">
                    
                    <?php if($char->is_resgatada): ?>
                    ...
                    <div class="absolute top-2 right-2 flex gap-2 z-20 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-4 group-hover:translate-x-0">
                        <a href="<?php echo e(route('fichas.edit', $char->id)); ?>" 
                        ...
                        <form action="<?php echo e(route('fichas.destroy', $char->id)); ?>" method="POST" 
                        ...
                        <?php if(!$char->is_resgatada && $char->user_id === Auth::id()): ?>
                            <button onclick="shareFicha(<?php echo e($char->id); ?>)" 
                    ...
                    <a href="<?php echo e(route('fichas.show', $char->id)); ?>" class="flex flex-col h-full">
                        <div class="h-60 overflow-hidden bg-black border-b border-cyan-500/30 relative">
                            <?php if($char->image): ?>
                            <img src="<?php echo e(route('media.show', $char->image)); ?>" 
                        ...
                        <div class="p-5 flex-1 flex flex-col bg-gradient-to-b from-black/80 to-cyan-950/20">
                            <h3 class="text-xl font-display font-black uppercase text-white tracking-tighter truncate border-l-4 border-cyan-500 pl-3 mb-1 group-hover:border-white transition-all">
                                <?php echo e($char->name); ?>

                            </h3>
                            
                            <div class="flex justify-between items-center mt-2">
                                <span class="text-[10px] font-mono text-cyan-400 font-bold">ID_<?php echo e(str_pad($char->id, 6, '0', STR_PAD_LEFT)); ?></span>
                                <div class="flex items-center gap-1">
                                    <span class="text-[8px] text-gray-500 uppercase">Peculiaridade:</span>
                                    <span class="text-[9px] text-emerald-400 font-bold uppercase"><?php echo e($char->class_sub); ?></span>
                                </div>
                            </div>

                            <?php if($char->is_resgatada && $char->originalUser): ?>
                                <div class="text-[8px] text-gray-400 mt-1">
                                    Criado por: <span class="text-white"><?php echo e($char->originalUser->name); ?></span>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="mt-auto pt-4">
                                <div class="flex items-center justify-between mb-2">
                                    ...
                                    <span class="text-[10px] text-cyan-300 font-black italic">LVL <?php echo e($char->level); ?></span>
                                </div>
                                <div class="w-full h-1 bg-gray-800 rounded-full overflow-hidden border border-white/5">
                                    <div class="h-full bg-cyan-500 shadow-[0_0_8px_cyan]" style="width: <?php echo e(min($char->level, 100)); ?>%"></div>
                                </div>
                            </div>
                        </div>
                    </a>
    ...
    <div id="resgatar-modal" class="fixed inset-0 z-50 hidden flex items-center justify-center bg-black/70 backdrop-blur-sm">
        <div class="bg-gray-900 border border-cyan-500/30 rounded-lg p-6 max-w-md w-full mx-4 shadow-2xl">
            ...
            <form action="<?php echo e(route('fichas.resgatar')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\Users\vinig\OneDrive\Documentos\GitHub\Ark-RPG\resources\views/fichas/index.blade.php ENDPATH**/ ?>