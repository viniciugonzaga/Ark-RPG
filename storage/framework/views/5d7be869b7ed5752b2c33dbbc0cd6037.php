...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Dino Runner - RPG ARK <?php $__env->endSlot(); ?>
        ...
        <div class="relative w-full max-w-md mx-auto">
            ...
            <div class="relative rounded-xl border-2 border-red-500/40 bg-slate-950/90 shadow-[0_0_60px_rgba(239,68,68,0.35)] px-6 py-8 md:px-10 md:py-10 text-center">
                ...
                <div class="relative inline-block mb-3">
                    ...
                    <img id="dinoDeadSprite" src="<?php echo e(asset('images/Dino_sprite_morto.png')); ?>" alt="Dino derrotado" class="relative w-24 h-24 md:w-28 md:h-28 mx-auto pixelated drop-shadow-[0_0_25px_rgba(239,68,68,0.55)]">
                </div>
    ...
    <script>
        (function() {
            ...
            async function syncLocalBest() {
                ...
                try {
                    const response = await fetch('<?php echo e(route("dino.record")); ?>', {
                        method: 'POST',
                        headers: {
            ...
            async function fetchBest() {
                try {
                    const response = await fetch('<?php echo e(route("dino.record.get")); ?>');
                    ...
                    if (!isAuthenticated) {
                        ...
                        await syncLocalBest();
                        const response2 = await fetch('<?php echo e(route("dino.record.get")); ?>');
...
<?php endif; ?><?php /**PATH C:\Users\vinig\OneDrive\Documentos\GitHub\Ark-RPG\resources\views/jogo.blade.php ENDPATH**/ ?>