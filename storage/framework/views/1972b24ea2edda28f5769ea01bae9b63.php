...
<?php $component->withAttributes([]); ?>
    ...
    <div class="fixed inset-0 -z-10">
        <img src="<?php echo e(asset('images/'.$bgShow)); ?>" alt="Background" class="w-full h-full object-cover opacity-40">
    ...
    <style>
        ...
        :root {
            --theme-primary: <?php echo e($primaryColor); ?>;
            --theme-secondary: <?php echo e($secondaryColor); ?>;
            --theme-glow: <?php echo e($primaryColor); ?>80;
            --theme-border: <?php echo e($primaryColor); ?>40;
        }
        ...
        .dna-overlay::after {
            ...
            background:repeating-linear-gradient(45deg,transparent,transparent 10px,<?php echo e($primaryColor); ?>0d 10px,<?php echo e($primaryColor); ?>0d 20px);
    ...
    <div id="capture-area" class="relative py-12 px-6 max-w-7xl mx-auto mb-20 min-h-screen">
        <div class="flex justify-between items-center mb-10 animate-fadeInUp no-print">
            ...
            <div class="flex gap-4">
                <?php if($ficha->user_id === Auth::id()): ?>
                    <a href="<?php echo e(route('fichas.edit', $ficha->id)); ?>" class="btn-neon">EDITAR DADOS</a>
                    <?php if(!$ficha->is_resgatada): ?>
                        <button onclick="compartilharFicha(<?php echo e($ficha->id); ?>)" class="btn-neon" style="border-color: #fbbf24; color: #fbbf24; box-shadow: 0 0 12px rgba(251,191,36,0.5);">
                            COMPARTILHAR
                        </button>
                    <?php endif; ?>
                <?php endif; ?>
        ...
        <?php if($ficha->is_resgatada && $ficha->originalUser): ?>
            <div class="mb-4 p-2 bg-white/10 border border-white/20 rounded-lg text-center text-sm text-gray-300">
                ...
                <span class="text-cyan-300 font-bold"><?php echo e($ficha->originalUser->name); ?></span>
            </div>
        <?php endif; ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="space-y-6 animate-fadeInUp" style="animation-delay:0.1s">
                <div class="ark-panel !p-1 relative group overflow-hidden dna-overlay">
                    <div id="watermark-image-show" class="absolute inset-0 bg-cover bg-center opacity-20 pointer-events-none"
                         style="background-image: url('<?php echo e(asset('images/'.$watermarkFile)); ?>'); background-repeat: no-repeat; background-position: center;"></div>
                    <?php if($ficha->image): ?>
                        <img src="<?php echo e(route('media.show', $ficha->image)); ?>" class="w-full grayscale group-hover:grayscale-0 transition-all duration-700 group-hover:scale-105">
                    <?php else: ?>
                ...
                <div class="ark-panel !p-6">
                    ...
                    <div class="grid grid-cols-1 gap-5">
                        <?php $stats=['vida'=>['color'=>'text-emerald-400','label'=>'Vida'],'armadura'=>['color'=>'text-gray-300','label'=>'Armadura'],'determinacao'=>['color'=>'text-purple-400','label'=>'Determinação'],'folego'=>['color'=>'text-cyan-300','label'=>'Fôlego'],'resistencia'=>['color'=>'text-amber-400','label'=>'Resistência']]; ?>
                ...
                <div class="ark-panel !p-6">
                    ...
                    <div class="atributos-container">
                        <img src="<?php echo e(asset('images/'.$atributosFile)); ?>" alt="Árvore de Atributos" class="atributos-imagem">
                        <div class="atributo-bolha" style="top: <?php echo e($posAtual['for']['top'] ?? 'auto'); ?>; left: <?php echo e($posAtual['for']['left'] ?? 'auto'); ?>;">
                            <span class="atributo-sigla">FOR</span>
                            <span class="atributo-valor"><?php echo e($ficha->for ?? 0); ?></span>
                        </div>
                        <div class="atributo-bolha" style="top: <?php echo e($posAtual['agi']['top'] ?? 'auto'); ?>; left: <?php echo e($posAtual['agi']['left'] ?? 'auto'); ?>;">
                            <span class="atributo-sigla">AGI</span>
                            <span class="atributo-valor"><?php echo e($ficha->agi ?? 0); ?></span>
                        </div>
                        <div class="atributo-bolha" style="top: <?php echo e($posAtual['int']['top'] ?? 'auto'); ?>; right: <?php echo e($posAtual['int']['right'] ?? 'auto'); ?>; left: <?php echo e($posAtual['int']['left'] ?? 'auto'); ?>;">
                            <span class="atributo-sigla">INT</span>
                            <span class="atributo-valor"><?php echo e($ficha->int ?? 0); ?></span>
                        </div>
                        <div class="atributo-bolha" style="bottom: <?php echo e($posAtual['set']['bottom'] ?? 'auto'); ?>; left: <?php echo e($posAtual['set']['left'] ?? 'auto'); ?>; top: <?php echo e($posAtual['set']['top'] ?? 'auto'); ?>;">
                            <span class="atributo-sigla">SET</span>
                            <span class="atributo-valor"><?php echo e($ficha->set ?? 0); ?></span>
                        </div>
                        <div class="atributo-bolha" style="bottom: <?php echo e($posAtual['vig']['bottom'] ?? 'auto'); ?>; right: <?php echo e($posAtual['vig']['right'] ?? 'auto'); ?>; top: <?php echo e($posAtual['vig']['top'] ?? 'auto'); ?>; left: <?php echo e($posAtual['vig']['left'] ?? 'auto'); ?>;">
            ...
            <div class="lg:col-span-2 space-y-6 animate-fadeInUp" style="animation-delay:0.2s">
                <div class="ark-panel !p-8 relative overflow-hidden">
                    <div class="absolute top-0 right-0 p-6 opacity-5 text-8xl font-medieval font-black uppercase italic pointer-events-none"><?php echo e($ficha->class_main); ?></div>
                    <div class="flex flex-col md:flex-row justify-between items-start mb-6 relative gap-6">
                        <div>
                            <h1 class="text-6xl font-medieval font-black text-white leading-none uppercase tracking-tighter"><?php echo e($ficha->name); ?></h1>
                            <p class="theme-text-primary tracking-[0.3em] font-bold uppercase mt-3 text-sm"><?php echo e($ficha->class_sub); ?> · <?php echo e($ficha->class_main); ?></p>
                            <p class="text-xs text-gray-400 mt-2 uppercase tracking-wider">Origem: <?php echo e($ficha->class_main); ?> | Idade: <?php echo e($ficha->age ?? '??'); ?> anos</p>
                        </div>
                    ...
                    <div x-data="{ expanded: false }" class="mt-4">
                        ...
                        <div :class="expanded ? 'expanded' : 'collapsed'" class="collapse-container collapsed relative">
                            <div class="bg-black/40 p-5 rounded-lg border-l-4 leading-relaxed text-sm italic text-gray-300" style="border-left-color:var(--theme-primary)">
                                <?php echo e($ficha->lore ?: 'Nenhum registro de lore encontrado.'); ?>
    ...
    <div id="pdf-page-1" class="pdf-page">
        <div class="pdfi-root" style="--P:<?php echo e($primaryColor); ?>;--B:<?php echo e($primaryColor); ?>40;">
            <div class="pdfi-watermark"><img src="<?php echo e(asset('images/'.$watermarkFilePdf)); ?>"></div>
            <div style="position:relative;z-index:1;">
                <div class="pdfi-header">
                    <div class="pdfi-header-left">
                        <img class="pdfi-header-logo" src="<?php echo e(asset('images/Icone_ark_v4_sum_fundo.png')); ?>">
                        <div>
                            <div class="pdfi-header-title">FICHA DO SOBREVIVENTE</div>
                            <div class="pdfi-header-sub">PECULIARIDADE: <?php echo e(strtoupper($peculiaridade)); ?></div>
                        </div>
                    </div>
                    <div class="pdfi-header-right">
                        <div class="pdfi-header-name"><?php echo e($ficha->name); ?></div>
                        <div class="pdfi-header-class"><?php echo e($ficha->class_sub); ?> — NV <?php echo e($ficha->level); ?></div>
                    </div>
                </div>
                <div style="display:grid;grid-template-columns:260px 220px 1fr;gap:24px;align-items:start;">
                    <div style="display:flex;flex-direction:column;gap:16px;">
                        <div style="border:1px solid var(--B);border-radius:8px;overflow:hidden;position:relative;">
                            <?php if($ficha->image): ?>
                                <img src="<?php echo e(route('media.show', $ficha->image)); ?>" style="width:100%;display:block;filter:grayscale(20%);">
                            <?php else: ?>
                        ...
                        <div class="pdfi-panel">
                            ...
                            <?php $sv=[['k'=>'vida','c'=>'#34d399','l'=>'Vida'],['k'=>'armadura','c'=>'#d1d5db','l'=>'Armadura'],['k'=>'determinacao','c'=>'#a78bfa','l'=>'Determinação'],['k'=>'folego','c'=>'#67e8f9','l'=>'Fôlego'],['k'=>'resistencia','c'=>'#fbbf24','l'=>'Resistência']]; ?>
                            <?php $__currentLoopData = $sv; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="pdfi-stat-row">
                                    <span class="pdfi-stat-label"><?php echo e($s['l']); ?></span>
                                    <span class="pdfi-stat-value" style="color:<?php echo e($s['c']); ?>;"><?php echo e($ficha->{$s['k']} ?? 0); ?></span>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                    <div style="display:flex;flex-direction:column;gap:16px;">
                        <div class="pdfi-panel">
                            ...
                            <div class="pdfi-attrs">
                                <div class="pdfi-attr-circle"><span class="pdfi-attr-sigla">FOR</span><span class="pdfi-attr-val"><?php echo e($ficha->for ?? 0); ?></span></div>
                                <div class="pdfi-attr-circle"><span class="pdfi-attr-sigla">AGI</span><span class="pdfi-attr-val"><?php echo e($ficha->agi ?? 0); ?></span></div>
                                <div class="pdfi-attr-circle"><span class="pdfi-attr-sigla">SET</span><span class="pdfi-attr-val"><?php echo e($ficha->set ?? 0); ?></span></div>
                                <div class="pdfi-attr-circle"><span class="pdfi-attr-sigla">VIG</span><span class="pdfi-attr-val"><?php echo e($ficha->vig ?? 0); ?></span></div>
                                <div class="pdfi-attr-circle pdfi-attr-center"><span class="pdfi-attr-sigla">INT</span><span class="pdfi-attr-val"><?php echo e($ficha->int ?? 0); ?></span></div>
                            </div>
                        </div>
                        <div class="pdfi-panel">
                            <div class="pdfi-panel-head">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = ($ficha->mutations??collect())->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div style="background:rgba(0,0,0,0.4);padding:10px;border-radius:6px;border:1px solid var(--B);margin-bottom:8px;">
                                    <div style="font-size:8px;color:var(--P);font-weight:700;text-transform:uppercase;letter-spacing:2px;"><?php echo e($m->origin); ?></div>
                                    <div style="font-size:12px;font-weight:900;color:#fff;text-transform:uppercase;margin:2px 0;"><?php echo e($m->name); ?></div>
                                    <div style="font-size:10px;color:#888;line-height:1.5;"><?php echo e(Str::limit($m->description,90)); ?></div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <p style="font-size:11px;color:#444;font-style:italic;text-align:center;padding:12px 0;">Nenhuma mutação.</p>
                            <?php endif; ?>
                            <?php if(($ficha->mutations??collect())->count()>2): ?>
                                <p style="font-size:9px;color:var(--P);opacity:0.6;text-align:center;margin-top:4px;">+<?php echo e(($ficha->mutations->count()-2)); ?> na página de mutações</p>
                            <?php endif; ?>
                        </div>
                        <div class="pdfi-panel">
                            <div class="pdfi-panel-head">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = collect($ficha->bonuses??[])->sortByDesc('value')->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div style="display:flex;justify-content:space-between;align-items:center;background:rgba(0,0,0,0.4);padding:8px 10px;border-radius:6px;border:1px solid var(--B);margin-bottom:6px;">
                                    <span style="font-size:10px;font-weight:700;color:#ccc;text-transform:uppercase;"><?php echo e($b->name); ?></span>
                                    <span style="font-size:18px;font-weight:900;color:var(--P);">+<?php echo e($b->value); ?></span>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <div style="display:flex;flex-direction:column;gap:16px;">
                        <div style="background:rgba(0,0,0,0.5);border:1px solid var(--B);border-radius:10px;padding:24px;position:relative;overflow:hidden;">
                            <div style="position:absolute;top:0;right:0;padding:16px;font-size:70px;font-weight:900;color:#fff;opacity:0.03;text-transform:uppercase;font-style:italic;line-height:1;"><?php echo e($ficha->class_main); ?></div>
                            <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:16px;">
                                <div>
                                    <h1 style="font-size:40px;font-weight:900;color:#fff;text-transform:uppercase;letter-spacing:-2px;line-height:1;margin:0;"><?php echo e($ficha->name); ?></h1>
                                    <p style="color:var(--P);letter-spacing:4px;font-weight:700;text-transform:uppercase;margin:6px 0 2px;font-size:10px;"><?php echo e($ficha->class_sub); ?> · <?php echo e($ficha->class_main); ?></p>
                                    <p style="font-size:9px;color:#666;text-transform:uppercase;letter-spacing:2px;margin:0;">Origem: <?php echo e($ficha->class_main); ?> | Idade: <?php echo e($ficha->age ?? '??'); ?> anos</p>
                                </div>
                                <div style="text-align:right;border-left:1px solid var(--B);padding-left:18px;min-width:80px;flex-shrink:0;">
                                    ...
                                    <span style="font-size:60px;font-weight:900;color:#fff;line-height:1;"><?php echo e($ficha->level); ?></span>
                                </div>
                            </div>
                            <div style="margin-top:16px;border-top:1px solid rgba(255,255,255,0.08);padding-top:14px;">
                                ...
                                <div style="background:rgba(0,0,0,0.4);padding:12px 16px;border-radius:6px;border-left:3px solid var(--P);">
                                    <p class="pdfi-clamp pdfi-lore-preview" style="font-size:10px;color:#aaa;font-style:italic;line-height:1.7;margin:0;"><?php echo e($ficha->lore ?: 'Nenhum registro encontrado.'); ?></p>
                                </div>
                        ...
                        <div class="pdfi-panel">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = ($ficha->survivorPowers??collect())->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div style="background:rgba(0,0,0,0.4);padding:10px;border-radius:6px;border:1px solid var(--B);margin-bottom:8px;">
                                    <div style="font-size:12px;font-weight:900;color:#fff;text-transform:uppercase;"><?php echo e($p->name); ?></div>
                                    <div class="pdfi-clamp pdfi-text-preview" style="font-size:10px;color:#888;line-height:1.5;margin-top:3px;"><?php echo e($p->description); ?></div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <p style="font-size:11px;color:#444;font-style:italic;text-align:center;padding:12px 0;">Sem poderes.</p>
                            <?php endif; ?>
                            <?php if(($ficha->survivorPowers??collect())->count()>2): ?>
                                <p style="font-size:9px;color:var(--P);opacity:0.6;text-align:center;margin-top:4px;">+<?php echo e(($ficha->survivorPowers->count()-2)); ?> na página de poderes</p>
                            <?php endif; ?>
                        </div>
                        <div class="pdfi-panel">
                            <div class="pdfi-panel-head">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = ($ficha->rituals??collect())->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div style="background:rgba(0,0,0,0.4);padding:10px;border-radius:6px;border:1px solid var(--B);margin-bottom:8px;">
                                    <div style="display:flex;align-items:center;gap:6px;margin-bottom:4px;">
                                        <span style="font-size:7px;background:rgba(153,27,27,0.6);color:#fca5a5;padding:2px 6px;border-radius:3px;font-weight:900;text-transform:uppercase;"><?php echo e($r->type??'Protocolo'); ?></span>
                                        <span style="font-size:12px;font-weight:900;color:#fff;text-transform:uppercase;"><?php echo e($r->name); ?></span>
                                    </div>
                                    <div class="pdfi-clamp pdfi-text-preview" style="font-size:10px;color:#888;line-height:1.5;"><?php echo e($r->description); ?></div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <p style="font-size:11px;color:#444;font-style:italic;text-align:center;padding:12px 0;">Sem rituais.</p>
                            <?php endif; ?>
                            <?php if(($ficha->rituals??collect())->count()>2): ?>
                                <p style="font-size:9px;color:var(--P);opacity:0.6;text-align:center;margin-top:4px;">+<?php echo e(($ficha->rituals->count()-2)); ?> na página de rituais</p>
                            <?php endif; ?>
                        </div>
                        <div class="pdfi-panel">
                            <div class="pdfi-panel-head">
                            ...
                            <div class="pdfi-clamp pdfi-inventory-preview" style="font-family:monospace;font-size:10px;color:#aaa;background:rgba(0,0,0,0.4);padding:14px;border-radius:6px;border:1px solid var(--B);white-space:pre-wrap;line-height:1.6;"><?php echo e(trim($ficha->arsenal)?:'NENHUM EQUIPAMENTO REGISTRADO.'); ?></div>
                        </div>
                    </div>
                </div>
                <div class="pdfi-footer">
                    <span>ARK — Sistema de RPG</span>
                    <span><?php echo e($ficha->name); ?> · Principal</span>
                    <span>Gerado em <?php echo e(now()->format('d/m/Y')); ?></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        const watermarkFilePdf = '<?php echo e($watermarkFilePdf); ?>';
        ...
        async function gerarPDF(button) {
            ...
            try {
                ...
                const nome = `FICHA_ARK_<?php echo e(strtoupper(str_replace(' ', '_', $ficha->name))); ?>.pdf`;
                pdf.save(nome);
...
<?php endif; ?><?php /**PATH C:\Users\vinig\OneDrive\Documentos\GitHub\Ark-RPG\resources\views/fichas/show.blade.php ENDPATH**/ ?>