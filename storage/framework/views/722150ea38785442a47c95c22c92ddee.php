...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Rolagens - ARK RPG <?php $__env->endSlot(); ?>
    ...
    <meta property="og:image" content="<?php echo e(asset('images/capa_rolagens.png')); ?>" />

    
    <div class="fixed inset-0 -z-10">
        <img src="<?php echo e(asset('images/fundo_rolagens.png')); ?>" class="w-full h-full object-cover opacity-40">
    ...
    <div class="relative z-10 max-w-7xl mx-auto p-6 space-y-8 text-white">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2 ark-panel p-6 relative overflow-hidden animate-fadeInUp">
                ...
                <div class="absolute top-0 right-0 w-full h-full opacity-10 pointer-events-none bg-no-repeat bg-right" 
                     style="background-image: url('<?php echo e(asset('images/bg_scan.gif')); ?>'); background-size: 200px; background-position: right center;"></div>
                ...
                <select id="character-select" class="ark-input w-full">
                    ...
                    <?php $__currentLoopData = $characters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $char): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($char->id); ?>" data-civilization="<?php echo e(strtolower($char->class_sub)); ?>" class="bg-black"><?php echo e(strtoupper($char->name)); ?> (NÍVEL <?php echo e($char->level); ?>)</option>
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="grid grid-cols-6 gap-2">
                            <?php $__currentLoopData = [5,10,15,20,25,30]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button onclick="setBonus(<?php echo e($b); ?>)" class="bg-black/40 border border-cyan-400/20 hover:bg-cyan-500/30 text-cyan-200 text-xs font-bold p-2 rounded-lg transition-all hover:scale-105">
                                    +<?php echo e($b); ?>
                ...
                <div class="ark-panel p-6 animate-fadeInUp" style="animation-delay: 0.4s">
                    ...
                    <div class="events-grid">
                        ...
                        <div class="event-block" data-event-type="sobrevivencia">
                            <img src="<?php echo e(asset('images/evento_sobrevivencia_icon.png')); ?>" class="event-icon tooltip-icon pulse-glow" alt="Ícone Sobrevivência">
                            <div class="flex flex-col items-start gap-1">
                                <span class="event-label">Sobrevivência</span>
                                <img src="<?php echo e(asset('images/rolar_evento_text.png')); ?>" class="event-text-img" alt="Rolar Evento">
                            </div>
                        </div>
                        ...
                        <div class="event-block" data-event-type="efeito">
                            <img src="<?php echo e(asset('images/evento_efeito_icon.png')); ?>" class="event-icon tooltip-icon pulse-glow" alt="Ícone Efeito">
                            <div class="flex flex-col items-start gap-1">
                        ...
                        <div class="event-block" data-event-type="item">
                            <img src="<?php echo e(asset('images/evento_item_icon.png')); ?>" class="event-icon tooltip-icon pulse-glow" alt="Ícone Item">
                            <div class="flex flex-col items-start gap-1">
                        ...
                        <div class="event-block" data-event-type="traumas">
                            <img src="<?php echo e(asset('images/evento_traumas_icon.png')); ?>" class="event-icon tooltip-icon pulse-glow" alt="Ícone Traumas">
                            <div class="flex flex-col items-start gap-1">
                        ...
                        <div class="event-block" data-event-type="epicos">
                            <img src="<?php echo e(asset('images/evento_epicos_icon.png')); ?>" class="event-icon tooltip-icon pulse-glow" alt="Ícone Épicos">
                            <div class="flex flex-col items-start gap-1">
                        ...
                        <div class="event-block" data-event-type="joias">
                            <img src="<?php echo e(asset('images/evento_joias_icon.png')); ?>" class="event-icon tooltip-icon pulse-glow" alt="Ícone Joias">
                            <div class="flex flex-col items-start gap-1">
                        ...
                        <div class="event-block" data-event-type="joias_raras">
                            <img src="<?php echo e(asset('images/evento_joias_raras_icon.png')); ?>" class="event-icon tooltip-icon pulse-glow" alt="Ícone Joias Raras">
                            <div class="flex flex-col items-start gap-1">
                        ...
                        <div class="event-block" data-event-type="frutas">
                            <img src="<?php echo e(asset('images/evento_frutas_icon.png')); ?>" class="event-icon tooltip-icon pulse-glow" alt="Ícone Frutas">
                            <div class="flex flex-col items-start gap-1">
        ...
        <div id="session-area" class="ark-panel p-6 hidden animate-fadeInUp mt-8">
            <div class="flex justify-between items-start mb-4">
                ...
                <form action="<?php echo e(route('session.sair')); ?>" method="POST" onsubmit="return confirm('Deseja sair da sessão atual?')">
                    <?php echo csrf_field(); ?>
            ...
            for(let i=0; i<3; i++){
                ...
                div.innerHTML = `
                    <div class="flex items-center gap-2">
                        <div class="attr-icon">
                            <img src="<?php echo e(asset('images/dice_icon_atributo.png')); ?>" alt="dado">
                        </div>
...
<?php endif; ?><?php /**PATH C:\Users\vinig\OneDrive\Documentos\GitHub\Ark-RPG\resources\views/roll/index.blade.php ENDPATH**/ ?>