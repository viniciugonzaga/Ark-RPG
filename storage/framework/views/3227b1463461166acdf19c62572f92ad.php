...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Entrar em Sessão - ARK RPG <?php $__env->endSlot(); ?>

    
    <div class="fixed inset-0 -z-10">
        <img src="<?php echo e(asset('images/fundo_entrar_sessao.png')); ?>" class="w-full h-full object-cover opacity-40">
    ...
    <div class="relative z-10 max-w-md mx-auto p-6 mt-20">
        <div class="ark-panel p-8 text-center relative overflow-hidden animate-fadeInUp">
            ...
            <form action="<?php echo e(route('session.entrar')); ?>" method="POST">
                <?php echo csrf_field(); ?>
            ...
            <div class="mt-6 pt-4 border-t border-cyan-500/20">
                <a href="<?php echo e(route('rolagens.index')); ?>" class="text-xs theme-text-primary hover:text-white transition flex items-center justify-center gap-1 group">
...
<?php endif; ?><?php /**PATH C:\Users\vinig\OneDrive\Documentos\GitHub\Ark-RPG\resources\views/session/entrar.blade.php ENDPATH**/ ?>