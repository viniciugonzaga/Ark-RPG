...
<?php $component->withAttributes([]); ?>
    ...
    <form action="<?php echo e(route('fichas.store')); ?>" method="POST" enctype="multipart/form-data" id="create-character-form" class="relative max-w-7xl mx-auto p-6 space-y-10 pb-20 text-gray-100">
        <?php echo csrf_field(); ?>
        ...
        <div class="ark-panel !p-4 animate-fadeInUp delay-100">
            ...
            <div class="atributos-container">
                <img id="atributos-img" src="<?php echo e(asset('images/icon_atributos_ark.png')); ?>" alt="Árvore de Atributos" class="atributos-imagem">
        ...
        <div class="ark-panel !p-8 bg-cyan-900/10 animate-fadeInUp delay-700">
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-6 pt-4">
                <?php $__currentLoopData = ['vida','armadura','determinacao','folego','resistencia']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex flex-col">
                        <label class="text-[10px] font-black text-cyan-400 uppercase mb-3 tracking-widest"><?php echo e($stat); ?></label>
                        <input name="<?php echo e($stat); ?>" type="number" class="ark-input !text-center font-bold !text-xl" value="0">
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
        ...
        <div class="flex justify-center gap-6 pt-8 pb-12">
            <a href="<?php echo e(route('fichas.index')); ?>" class="btn-abort">Cancelar</a>
    ...
    <script>
        ...
        function setBackground(imageName) {
            ...
            if (bg) bg.src = `<?php echo e(asset('images/')); ?>/${imageName}`;
        }

        function setWatermark(imageName) {
            const wm = document.getElementById('watermark-image');
            if (wm) wm.style.backgroundImage = `url('<?php echo e(asset('images/')); ?>/${imageName}')`;
        }

        function setAtributosImage(imageName) {
            const img = document.getElementById('atributos-img');
            if (img) img.src = `<?php echo e(asset('images/')); ?>/${imageName}`;
        }
...
<?php endif; ?><?php /**PATH C:\Users\vinig\OneDrive\Documentos\GitHub\Ark-RPG\resources\views/fichas/create.blade.php ENDPATH**/ ?>