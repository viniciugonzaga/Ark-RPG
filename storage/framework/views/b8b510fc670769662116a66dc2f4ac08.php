...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Sessão: <?php echo e($session->session_code); ?> <?php $__env->endSlot(); ?>

    <div class="fixed inset-0 -z-10">
        <img src="<?php echo e(asset('images/fundo_sessao.png')); ?>" class="w-full h-full object-cover opacity-40">
        ...
        <div class="ark-panel p-6 flex justify-between items-center flex-wrap gap-4 relative overflow-hidden animate-fadeInUp">
            ...
            <div>
                ...
                <div class="flex items-center gap-3 mt-2">
                    ...
                    <div class="code-block" id="session-code"><?php echo e($session->session_code); ?></div>
            ...
            <div class="flex gap-4">
                <form action="<?php echo e(route('master.encerrar.mesa', $session->session_code)); ?>" method="POST" onsubmit="return confirm('Encerrar a mesa removerá todos os participantes. Continuar?')">
                    <?php echo csrf_field(); ?>
                    <button type="submit" class="btn-danger">Encerrar Mesa</button>
                </form>
                <a href="<?php echo e(route('master.mesa')); ?>" class="btn-neon flex items-center gap-1">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <script>
        ...
        const sessionCode = "<?php echo e($session->session_code); ?>";
                    ...
                    container.innerHTML = data.participants.map(p => `
                        <div class="participant-card p-4 flex items-center gap-4">
                            <div class="flex-shrink-0">
                                <img src="${p.foto || '<?php echo e(asset('images/default-avatar.png')); ?>'}" 
                                     alt="${p.name}" 
...
<?php endif; ?><?php /**PATH C:\Users\vinig\OneDrive\Documentos\GitHub\Ark-RPG\resources\views/master/sessao.blade.php ENDPATH**/ ?>