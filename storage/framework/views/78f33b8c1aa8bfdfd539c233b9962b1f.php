                ...
                <div class="flex flex-col space-y-6">
                    ...
                    <div class="flex justify-center">
                        <?php if(auth()->guard()->guest()): ?>
                            <a href="<?php echo e(route('register')); ?>" class="ark-btn-neon px-16 py-5 text-xl">
                                Faça seu Cadastro
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('fichas.index')); ?>" class="ark-btn-neon px-16 py-5 text-xl">
                                Acessar Fichas
                            </a>
                        <?php endif; ?>
                    </div>
...
<?php endif; ?><?php /**PATH C:\Projetos-ligmas\Projeto_Ark_Laravel\ark-rpg\resources\views/welcome.blade.php ENDPATH**/ ?>